...
import numpy as np
import joblib
from lib.settings import MODEL_ROOT, DATA_ROOT, MODEL_NAME, RANDOM_STATE, TEST_SIZE
...
def cv_hyperparameters(X, y):
    ...
    grid = {
        ...
        'max_depth': [None] + list(np.arange(5, 100, 5)), # unlimited depth may be the best, who knows
...
if __name__ == '__main__':
    ...
    if not os.path.exists(MODEL_ROOT):
        ...
        if user_input == 'y':
            ...
            print(f'Model saved in {MODEL_ROOT}/')
    else:
