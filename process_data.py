...
if __name__ == "__main__":
    ...
    try:
        result = subprocess.run(['py', 'lib/import_data.py', args], capture_output=True, text=True, check=True)
        print(result.stdout)
        result = subprocess.run(['py', 'lib/clean_data.py', args], capture_output=True, text=True, check=True)
        print(result.stdout)
